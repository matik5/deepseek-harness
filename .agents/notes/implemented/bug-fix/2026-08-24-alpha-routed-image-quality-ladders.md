...
This decision partially supersedes the [unified image request pipeline note](../feature/2026-08-20-unified-image-request-pipeline.md) for durable normalization. Model-request projection uses JPEG for endpoints without WebP decoding.
